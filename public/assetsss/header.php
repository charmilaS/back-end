											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														...
														<small class="d-block">29 March 2023 - 02:26 PM</small>
													</div>
												</div>
											</li>
											<li>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<!-- antigo href javascript:void() -->
                    <!-- <li><a class="has-arrow " href="user/index.php" >
                    ...
                    <!-- <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">Usuarios</a></li>
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<div class="side-bar-profile-img">
							<img src="images/Transparente logo.png" alt="">
						</div>
						<div class="profile-info1">
							<h4 class="fs-18 font-w500">José Nuvunga</h4>
							<span>onesimonuvunga@gmail.com</span>
						</div>
					...
					<div class="d-flex justify-content-between mb-2 progress-info">
						<span class="fs-12"><i class="fas fa-star text-orange me-2"></i>Progresso da Tarefa</span>
						<span class="fs-12">20/100</span>
					</div>
				...
				<div class="copyright">
					<p><strong>onesimo Nuvunga</strong> © 2023 || Todos direitos reservados</p>
					<p class="fs-12">Feito por: <span class="heart"></span> OnesimoN.</p>
				</div>
			</div>
        </div>
