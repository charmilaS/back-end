    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="{{ asset('assets/img/logo/logosn.png') }}"
                        alt="" /></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    ...
                    <li>
                        ...
                        <a title="Landing Page" href="http://127.0.0.1:8000/" aria-expanded="false"><span
                                class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Inicio</span></a>
                        <a title="Landing Page" href="{{ route('course.index') }}" aria-expanded="false"><span
                                class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Usuários</span></a>
                        <a title="Landing Page" href="{{ route('course.index') }}" aria-expanded="false"><span
                                class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Cursos</span></a>
                        <a title="Landing Page" href="{{ route('inscription.index') }}" aria-expanded="false"><span
                                class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Inscrições</span></a>
                    </li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="assets/img/logo/logosn.png"
                                alt="" /></a>
                    </div>
                </div>
            </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu"
                                                        ...
                                                        <li><a href="#"><span
                                                                    class="edu-icon edu-home-admin author-log-ic"></span>Minha
                                                                Conta</a>
                                                        </li>
                                                ...
                                                <li><a href="#"><span
                                                            class="edu-icon edu-settings author-log-ic"></span>Definições</a>
                                                </li>
                                                <li><a href="#"><span
                                                            class="edu-icon edu-locked author-log-ic"></span>Sair</a>
                                                </li>
                                            </ul>
                                            </li>
